...
def main():
    ...
    # 加载RBF模型
    model_path = 'C:/Users/yeyue/Desktop/实验室工作用/论文2/Paper_Code/predict/best_model/rbf_ISD_RP_best_model.pkl'
    ...
    try:
        ...
        # 绘制混淆矩阵并保存
        plot_confusion_matrix(test_labels, predictions, 'RBF_confusion_matrix_ISD_rp.jpg', fault_types)
        print("\n混淆矩阵已保存为 RBF_confusion_matrix_ISD_rp.jpg")
